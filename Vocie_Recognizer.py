...
"color:white;")
    ...
    def retranslateUi(self, Voice_Recognizer):
        ...
        self.Hazem_CheckBox.setText(_translate("Voice_Recognizer", "Mohamed"))
        ...
        self.label_10.setText(_translate("Voice_Recognizer", "Mohamed Hazem"))
        self.label_9.setText(_translate("Voice_Recognizer", "Omar Khaled"))
        self.label_8.setText(_translate("Voice_Recognizer", "Ahmed Taha"))
        self.label_11.setText(_translate("Voice_Recognizer", "Youssef Hassanein"))
